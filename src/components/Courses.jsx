...
const Courses = () => (
  <section className="py-16 bg-gray-50 styleme">
    <div className="mb-10">
      <h3 className="text-2xl font-bold">Our Courses</h3>
      <p className="text-gray-600 mt-2">Explore a variety of creative and development topics</p>
    </div>
    <div className="grid md:grid-cols-3 gap-6">
      {courses.map(course => (
        <div key={course.id} className="flex flex-col bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div className="p-4">
            <button className="bg-gray-200 text-black py-2 px-4 rounded w-full">Get it Now</button>
          </div>
        </div>
      ))}
    </div>
