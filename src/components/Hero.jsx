...
const Hero = () => (
  <section className="text-center mb-10 p-20 bg-gray-50">
    ...
    <div className="flex justify-center space-x-4">
      <button className="bg-orange-500 text-white px-6 py-2 rounded">Browse Courses</button>
      <button className="border border-gray-400 px-6 py-2 rounded">View Pricing</button>
    </div>
  </section>
);
